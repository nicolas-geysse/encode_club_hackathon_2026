...
# NOTE: This checkpoint is blocking by design. This is LEGAL BLOCKER work
# (FERPA/GDPR privacy compliance). If verification finds issues, the context
# burn of a planner revision is justified. Privacy must be verified before
# shipping. This is not a normal feature checkpoint.
...
This is LEGAL BLOCKER work - FERPA/GDPR privacy compliance. If verification fails, the context cost of revision is justified. Privacy violations cannot ship. Unlike typical feature checkpoints where we'd prefer non-blocking, this one gates a legal requirement.
</objective>
